...
Agent-driven extraction: the agent analyses chunks exported by
``hafiz chunks export`` and produces a JSON payload that this command
stores into the knowledge graph. No external API key needed.
"""
